...
...First, install ruby by running `sudo apt install --yes ruby ruby-dev`.Subsequently, foreman can be installed by running `sudo gem install foreman`

* gunicorn v19.9.0 (or higher)

...This can be installed by running `sudo apt install --yes gunicorn3`

* flask v1.1.2

...This can be installed by running `pip3 install Flask`

* caddy v1.0.4 (or higher)

...This can be installed by running `curl https://getcaddy.com | bash -s personal`

* Faker v4.0.3

...This can be installed by running `pip3 install faker`

* Locust v0.14.5

...This can be installed by running `pip3 install locust`

* pytest v5.4.1

...This can be installed by running `pip3 install pytest`

* tavern v1.0.0

...This can be installed by running `pip3 install tavern`

A shell script (setup.sh) is provided that will install all these dependenies for the user. To run the setup enter the command: 
```
    bash setup.sh
```
